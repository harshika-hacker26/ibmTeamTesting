...
//        passwordInput.sendKeys(password);
//
//        new Select(daysSelect)
//                .selectByValue(JSONReader.accountDetails("day"));
//        new Select(monthsSelect)
//                .selectByValue(JSONReader.accountDetails("month"));
//        new Select(yearsSelect)
//                .selectByValue(JSONReader.accountDetails("year"));
//
//        newsletterCheckbox.click();
//        specialOffersCheckbox.click();
//
...
//                .selectByValue(JSONReader.accountDetails("country"));
//
//        stateInput.sendKeys(JSONReader.accountDetails("state"));
//        cityInput.sendKeys(JSONReader.accountDetails("city"));
//        zipcodeInput.sendKeys(JSONReader.accountDetails("zipcode"));
...
public class EnterAccountInformationPage {
    ...
    // ✅ REQUIRED BY TestCase1 (RESTORED METHOD)
    public WebElement getEnterAccountInformation() {
        return enterAccountInformation;
    }
